...
module HanlonMicrokernel
  class HnlMkFactManager
    ...
    def get_uuid
      ...
      # go directly to the source of the system-uuid information retrieved
      # by either the lshw or dmidecode information (above)
      %x[cat /sys/class/dmi/id/product_uuid]
    end
