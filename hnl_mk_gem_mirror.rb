...
# any gems. As such, we can't use any hanlon code here, as it tries to include JSON
...
# Logging - can't use hanlon logging here, see above
log_file = File.open "/var/log/hnl_mk_gem_mirror.log", 'a+'
